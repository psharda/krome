program test_krome
  ...
  do j=1,jmax
     !loop on H2 points
     do k=1,kmax
        xi(krome_idx_OH)  = 0.d0 !OH
        xi(krome_idx_O)   = 0.d0 !O
        ...
        xi(krome_idx_O2)  = (1d0 - xi(krome_idx_H2o) - xi(krome_idx_OH) &
             - xi(krome_idx_O)) / 2.d0
        xi(krome_idx_H)   = 2d0 -xi(krome_idx_OH) -2.d0*xi(krome_idx_H2O) &
             -2.d0*xi(krome_idx_H2)
