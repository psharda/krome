...
# NOTE: TIGRESS-NCR only tracks H, H2, C, C+, O, CO and e- -- it has no He, Si,
# H3+, CH or OH, so this plot has fewer panels than the full-network/GOW version.
...
fig, axs = plt.subplots(nrows=2, ncols=3, figsize=(16.2, 9.6),
...
panels = [
    ...
    # bottom row
    (1, 0, ["CO"],       [6],     r'$n_{\rm CO}\,(\rm cm^{-3})$'),
    (1, 1, ["E"],        [11],    r'$n_{\rm e}\,(\rm cm^{-3})$'),
    (1, 2, ["O"],        [7],     r'$n_{\rm O}\,(\rm cm^{-3})$'),
]
...
# Rollig benchmark (black lines) -- shared reference data, kept alongside the
# full-network benchmark rather than duplicated in every test directory
...
# y-limits for the first three panels
